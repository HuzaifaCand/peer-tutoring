          ...
          return (
            <button
              ...
              className={clsx(
                ...
                "after:absolute after:left-0 after:-bottom-0.5 after:h-[0.5px] after:w-full after:bg-gray-200/60 after:scale-x-0 after:origin-center after:transition-transform after:duration-300",
