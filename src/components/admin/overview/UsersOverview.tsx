        ...
        {items.map((item) => (
          <div key={item.type} className="flex flex-col gap-4 w-full">
            ...
            <Link
              ...
              className="mt-auto w-full text-center rounded-lg bg-mainBg hover:bg-elevatedBg border border-textWhite/10 transition text-textButton font-medium py-2 px-3 text-[13px] active:scale-95"
            >
